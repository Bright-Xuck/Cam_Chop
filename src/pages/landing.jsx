...
import sliderOne from "../assets/hero/sliderone.jpeg";
import sliderTwo from "../assets/hero/slidertwo.png";
...
export default function Landing() {
  ...
  return (
    <>
      <main className="pb-30 -mt-[5.5rem]">
        <section
        ...
        <section className="flex items-center w-4/5 gap-[8rem] h-[90vh] max-sm:flex-col mr-auto ml-auto max-sm:mt-[5rem]  max-sm:w-4/5 max-sm:h-[100vh] max-sm:gap-[2rem]">
          <div className="grid grid-cols-1 max-sm:flex">
            <img
              src="../photos/ScootScoot.svg"
              alt=""
              className="h-[15rem] max-sm:w-[8rem]"
            />
            <div>
              <h1 className="text-4xl font-bold mb-5 max-sm:text-2xl max-sm:mb-1.5">
                Become a Dasher
              </h1>
              <p>
              ...
              <p className="after:content-['→'] mt-5 text-red-600 text-3xl font-semibold max-sm:text-xl max-sm:mt-1.5">
                start earning
              </p>
            </div>
          </div>
          <div className="grid grid-cols-1 max-sm:flex">
            ...
            <div>
              ...
              <p>
                Attract new custmers and grow sales, starting with 0%
                commissions for up to 30 days.
              </p>
              <NavLink
                to={"/merchant/signup"}
                className="after:content-['→'] mt-5 text-red-600 text-2xl font-semibold max-sm:text-xl max-sm:mt-1.5"
              >
          ...
          <div className="grid grid-cols-5 items-center gap-[6rem] w-[90%] m-auto">
            ...
            <div className="col-span-2">
              <h1 className="text-5xl font-semibold">
                Everthing you crave, delivered.
              </h1>
              <h4 className="text-2xl font-semibold mt-3">
                Your favorite local restaurants
              </h4>
              <p className="text-xl mt-1 mb-3">
                Get a slice of pizza or the whole pie delivered, or pick up that
                burger for the road you've been meaning to try{" "}
              </p>
              <NavLink to={"/shop"} className="bg-red-500 p-3 rounded-4xl">
                Find restaurants
              </NavLink>
            </div>
          </div>
            ...
            <div className="grid grid-cols-5 items-center gap-[6rem] w-[90%] m-auto">
              ...
              <div className="col-span-2">
                ...
                <p className="text-xl mt-3 mb-3">
                  Members get a XAF0 delivery fee on CamChop-Free orders, 5%
                  back on pickup orders, and so much more{" "}
                </p>
                <NavLink to={"/signup"} className="bg-red-500 p-3 rounded-4xl">
                  Get CamChop-Free
                </NavLink>
              </div>
            </div>
        ...
        <article className="bg-[url(../photos/convenience_mobile.avif)] bg-no-repeat bg-cover bg-center h-[90vh] flex justify-center items-center">
          <div className="flex justify-center items-center flex-col w-2/5 text-center gap-6 text-white">
            ...
            <button className="bg-red-500 p-3 rounded-4xl">
              Shop Groceries
            </button>
          </div>
        </article>
        <section className="w-[90%] m-auto pt-16">
          <div className="grid grid-cols-5 items-center gap-[6rem]">
            ...
            <div className="col-span-2">
              ...
              <p className="text-xl mt-3 mb-3">
                Stock up on snacks, household essentials, candy, or vitamins —
        ...
        <section className="grid grid-cols-1 grid-rows-[auto,1fr,1fr] w-[90%] m-auto pt-20">
          <h1 className="text-center text-4xl w-[40%] m-auto pb-20">
          ...
          <div className="grid grid-cols-5 items-center gap-[6rem]">
            ...
            <div className="col-span-2">
              ...
              <NavLink
                to={"/merchant/signup"}
                className="bg-red-500 p-3 rounded-4xl"
              >
                Become a Partner
              </NavLink>
            </div>
