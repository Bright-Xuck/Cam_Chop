      ...
      <div className="bg-gradient-to-br from-red-50 to-orange-50 px-6 py-12">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
            ...
            From breakfast specials to dinner favorites, keep your offerings
            fresh and organized.
          </p>
          ...
          <div className="flex items-center justify-center">
            <NavLink
              to={"/merchant/addmenu"}
              className="bg-red-500 hover:bg-red-600 text-white px-6 py-3 rounded-lg font-semibold shadow-sm transition-colors"
            >
              Add New Menu
            </NavLink>
          </div>
