...
export default function Nav() {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full h-[5rem] border-b-2 shadow-md shadow-black z-50 bg-white">
      <div className="flex justify-between items-center h-full px-4 lg:pr-8 max-[400px]:px-0">
        ...
        <div className="hidden md:block">
          <div className="flex relative">
            ...
            {sidebarOpen && (
              <div className="absolute top-[5rem] left-0 right-0 bg-white border-b shadow-lg">
            ...
            <form
              action=""
              className="grid grid-cols-[auto_1fr_auto] items-center border rounded-2xl p-2 w-full max-w-[350px]"
            >
        ...
        <div className="md:hidden flex-1">
          <form
            action=""
            className="flex items-center border rounded-2xl p-2 max-w-[250px] max-sm:max-w-60"
          >
